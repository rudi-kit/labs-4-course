...
(deftest grehem-shell-test
  (is (= [[1 6] [7 6] [5 2]] (grehem-shell [[5 2] [7 6] [4 4] [1 6]])))
  (is (= [[3 6] [5 1] [1 1]] (grehem-shell [[1 1] [5 1] [3 3] [3 6]]))))

(def poligon1 [[3 6] [4 3] [7 2] [6 4] [8 5] [6 7] [3 9] [7 8]])
(deftest jarvis-algo-test
  ...
  (is (= '([1 0] [0 3] [2 5] [4 4] [5 3] [5 1] [1 0])   (jarvis-shell [[1 0] [5 1] [5 3] [4  2] [3 3] [4 4] [2 5] [0 3]])))
  (is (= '([7 2] [4 3] [3 6] [3 9] [7 8] [8 5] [7 2])   (jarvis-shell poligon1))))
