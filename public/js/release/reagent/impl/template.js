...
var G__26921 = o;
(G__26921[reagent.impl.template.cached_prop_name(k)] = (reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.convert_prop_value.cljs$core$IFn$_invoke$arity$1(v) : reagent.impl.template.convert_prop_value.call(null,v)));
...
while (G__26923__i < G__26923__a.length) {G__26923__a[G__26923__i] = arguments[G__26923__i + 0]; ++G__26923__i;}
  args = new cljs.core.IndexedSeq(G__26923__a,0,null);
} 
...
var G__26927 = jsprops;
(G__26927["defaultValue"] = value);

(G__26927["onChange"] = ((function (G__26927,v,value,on_change){
return (function (p1__26926_SHARP_){
return reagent.impl.template.input_handle_change(this$,on_change,p1__26926_SHARP_);
});})(G__26927,v,value,on_change))
);
...
var vec__26930 = cljs.core.next(cljs.core.re_matches(reagent.impl.template.re_tag,cljs.core.name(hiccup_tag)));
var tag = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26930,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26930,(1),null);
var class$ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26930,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___26934 = reagent.impl.template.key_from_vec(v);
if((temp__4661__auto___26934 == null)){
} else {
var key_26935 = temp__4661__auto___26934;
(jsprops["key"] = key_26935);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__26936 = reagent.impl.template.__GT_NativeWrapper();
(G__26936["name"] = c);
...
var G__26937 = cljs.core.with_meta(new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [reagent.impl.template.reagent_input(),argv,comp,jsprops,first_child], null),cljs.core.meta(argv));
return (reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1 ? reagent.impl.template.as_element.cljs$core$IFn$_invoke$arity$1(G__26937) : reagent.impl.template.as_element.call(null,G__26937));
} else {
...
var len__8814__auto___26942 = arguments.length;
var i__8815__auto___26943 = (0);
while(true){
if((i__8815__auto___26943 < len__8814__auto___26942)){
args__8821__auto__.push((arguments[i__8815__auto___26943]));

var G__26944 = (i__8815__auto___26943 + (1));
i__8815__auto___26943 = G__26944;
continue;
} else {
}
break;
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq26940){
var G__26941 = cljs.core.first(seq26940);
var seq26940__$1 = cljs.core.next(seq26940);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__26941,seq26940__$1);
});
...
break;
default:
var G__26947 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.cljs$core$IFn$_invoke$arity$3(n,(0),pos),cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(v,(0),cljs.core.subs.cljs$core$IFn$_invoke$arity$2(n,(pos + (1))))], null);
v = G__26947;
continue;
...
var n__8590__auto___26949 = a.length;
var i_26950 = (0);
while(true){
if((i_26950 < n__8590__auto___26949)){
(a[i_26950] = reagent.impl.template.as_element((a[i_26950])));
...
var a = cljs.core.into_array.cljs$core$IFn$_invoke$arity$1(s);
var n__8590__auto___26952 = a.length;
var i_26953 = (0);
while(true){
if((i_26953 < n__8590__auto___26952)){
var val_26954 = (a[i_26953]);
if((cljs.core.vector_QMARK_(val_26954)) && ((reagent.impl.template.key_from_vec(val_26954) == null))){
(o["no-key"] = true);
} else {
}

(a[i_26953] = reagent.impl.template.as_element(val_26954));

var G__26955 = (i_26953 + (1));
i_26953 = G__26955;
continue;
} else {
}
...
var ctx = ({});
var vec__26956 = reagent.ratom.check_derefs(((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev(x,ctx);
});})(ctx))
);
var res = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26956,(0),null);
var derefed = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__26956,(1),null);
...
var G__26959 = (cljs.core.count(argv) - first_child);
switch (G__26959) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv(((function (G__26959){
